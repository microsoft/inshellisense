		...
		Options: []model.Option{{
			...
			Args: []model.Arg{{
				...
				Suggestions: []model.Suggestion{{
					...
					Name:        []string{`clc++`, `clc++1.0`},
					Description: `C++ for OpenCL 1.0`,
				}, {
					Name:        []string{`clc++2021`},
