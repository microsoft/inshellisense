	...
	Specs["zig"] = model.Subcommand{
		...
		Subcommands: []model.Subcommand{{
			...
			Options: []model.Option{{
				...
				Name:        []string{"--prefix-include-dir"},
				...
				Name:        []string{"--prominent-compile-errors"},
				...
				ExclusiveOn: []string{"-fno-stage1"},
			}, {
				Name:        []string{"-fno-stage1"},
				Description: `Prevent using bootstrap compiler as the codegen backend`,
				ExclusiveOn: []string{"-fstage1"},
			}, {
				Name:        []string{"-freference-trace"},
				Description: `How many lines of reference trace should be shown per compile error`,
				ExclusiveOn: []string{"-fno-reference-trace"},
			}, {
				Name:        []string{"-fno-reference-trace"},
				Description: `Disable reference trace`,
				ExclusiveOn: []string{"-freference-trace"},
			}, {
				Name:        []string{"--build-file"},
			...
			Name:        []string{"ast-check"},
			Description: `Given a .zig source file, reports any compile errors that can be ascertained on the basis of the source code alone, without target information or type checking. If [file] is omitted, stdin is used.`,
			Args: []model.Arg{{
				Templates:  []model.Template{model.TemplateFilepaths},
				Name:       "file",
				IsOptional: true,
			...
			Options: []model.Option{{
				...
				Name:        []string{"-femit-bin"},
				Description: `(default) Output machine code`,
				ExclusiveOn: []string{"-fno-emit-bin"},
			}, {
				Name:        []string{"-fno-emit-bin"},
				Description: `Do not output machine code`,
				ExclusiveOn: []string{"-femit-bin"},
			}, {
				Name:        []string{"-femit-asm"},
				Description: `Output .s (assembly code)`,
				ExclusiveOn: []string{"-fno-emit-asm"},
			}, {
				Name:        []string{"-fno-emit-asm"},
				Description: `(default) Do not output .s (assembly code)`,
				ExclusiveOn: []string{"-femit-asm"},
			}, {
				Name:        []string{"-femit-llvm-ir"},
				Description: `Produce a .ll file with LLVM IR (requires LLVM extensions)`,
				ExclusiveOn: []string{"-fno-emit-llvm-ir"},
			}, {
				Name:        []string{"-fno-emit-llvm-ir"},
				Description: `(default) Do not produce a .ll file with LLVM IR`,
				ExclusiveOn: []string{"-femit-llvm-ir"},
			}, {
				Name:        []string{"-femit-llvm-bc"},
				Description: `Produce a LLVM module as a .bc file (requires LLVM extensions)`,
				ExclusiveOn: []string{"-fno-emit-llvm-bc"},
			}, {
				Name:        []string{"-fno-emit-llvm-bc"},
				Description: `(default) Do not produce a LLVM module as a .bc file`,
				ExclusiveOn: []string{"-femit-llvm-bc"},
			}, {
				Name:        []string{"-femit-h"},
				Description: `Generate a C header file (.h)`,
				ExclusiveOn: []string{"-fno-emit-h"},
			}, {
				Name:        []string{"-fno-emit-h"},
				Description: `(default) Do not generate a C header file (.h)`,
				ExclusiveOn: []string{"-femit-h"},
			}, {
				Name:        []string{"-femit-docs"},
				Description: `Create a docs/ dir with html documentation`,
				ExclusiveOn: []string{"-fno-emit-docs"},
			}, {
				Name:        []string{"-fno-emit-docs"},
				Description: `(default) Do not produce docs/ dir with html documentation`,
				ExclusiveOn: []string{"-femit-docs"},
			}, {
				Name:        []string{"-femit-analysis"},
				Description: `Write analysis JSON file with type information`,
				ExclusiveOn: []string{"-fno-emit-analysis"},
			}, {
				Name:        []string{"-fno-emit-analysis"},
				Description: `(default) Do not write analysis JSON file with type information`,
				ExclusiveOn: []string{"-femit-analysis"},
			}, {
				Name:        []string{"-femit-implib"},
				Description: `(default) Produce an import .lib when building a Windows DLL`,
				ExclusiveOn: []string{"-fno-emit-implib"},
			}, {
				Name:        []string{"-fno-emit-implib"},
				Description: `Do not produce an import .lib when building a Windows DLL`,
				ExclusiveOn: []string{"-femit-implib"},
			}, {
				Name:        []string{"--show-builtin"},
				...
				Args: []model.Arg{{
					Suggestions: []model.Suggestion{{Name: []string{`default`}}, {Name: []string{`tiny`}}, {Name: []string{`small`}}, {Name: []string{`kernel`}}, {Name: []string{`medium`}}, {Name: []string{`large`}}},
				}},
			}, {
				Name:        []string{"-mred-zone"},
				Description: `Force-enable the "red-zone"`,
				ExclusiveOn: []string{"-mno-red-zone"},
			}, {
				Name:        []string{"-mnored-zone"},
				Description: `Force-disable the "red-zone"`,
				ExclusiveOn: []string{"-mred-zone"},
			}, {
				Name:        []string{"-fomit-frame-pointer"},
				Description: `Omit the stack frame pointer`,
				ExclusiveOn: []string{"-fno-omit-frame-pointer"},
			}, {
				Name:        []string{"-fno-omit-frame-pointer"},
				Description: `Store the stack frame pointer`,
				ExclusiveOn: []string{"-fomit-frame-pointer"},
			}, {
				...
				Args: []model.Arg{{
					...
					Suggestions: []model.Suggestion{{
						...
						Name:        []string{`spirv`},
						Description: `Standard, Portable Intermediate Representation V (SPIR-V)`,
					}, {
						Name:        []string{`plan9`},
				...
				ExclusiveOn: []string{"-fno-soname"},
			}, {
				Name:        []string{"-fno-soname"},
				Description: `Disable emitting a SONAME`,
				ExclusiveOn: []string{"fsoname"},
			}, {
				Name:        []string{"-fLLD"},
				Description: `Force using LLD as the linker`,
				ExclusiveOn: []string{"-fno-LLD"},
			}, {
				Name:        []string{"-fno-LLD"},
				Description: `Prevent using LLD as the linker`,
				ExclusiveOn: []string{"-fLLD"},
			}, {
				Name:        []string{"-fcompiler-rt"},
				Description: `Always include compiler-rt symbols in output`,
				ExclusiveOn: []string{"-fno-compiler-rt"},
			}, {
				Name:        []string{"-fno-compiler-rt"},
				Description: `Prevent including compiler-rt symbols in output`,
				ExclusiveOn: []string{"-fcompiler-rt"},
			}, {
				Name:        []string{"-rdynamic"},
				...
				Name:        []string{"-feach-lib-rpath"},
				Description: `Ensure adding rpath for each used dynamic library`,
				ExclusiveOn: []string{"-fno-each-lib-rpath"},
			}, {
				Name:        []string{"-fno-each-lib-rpath"},
				Description: `Prevent adding rpath for each used dynamic library`,
				ExclusiveOn: []string{"-feach-lib-rpath"},
			}, {
				Name:        []string{"-fallow-shlib-undefined"},
				Description: `Allows undefined symbols in shared libraries`,
				ExclusiveOn: []string{"-fno-allow-shlib-undefined"},
			}, {
				Name:        []string{"-fno-allow-shlib-undefined"},
				Description: `Disallows undefined symbols in shared libraries`,
				ExclusiveOn: []string{"-fallow-shlib-undefined"},
			}, {
				Name:        []string{"-fbuild-id"},
				Description: `Helps coordinate stripped binaries with debug symbols`,
				ExclusiveOn: []string{"-fno-build-id"},
			}, {
				Name:        []string{"-fno-build-id"},
				Description: `(default) Saves a bit of time linking`,
				ExclusiveOn: []string{"-fbuild-id"},
			}, {
				Name:        []string{"--eh-frame-hdr"},
				Description: `Enable C++ exception handling by passing --eh-frame-hdr to linker`,
			}, {
				Name:        []string{"--emit-relocs"},
				...
				Args: []model.Arg{{
					Name: "arg",
					Suggestions: []model.Suggestion{{
						Name:        []string{`nodelete`},
						Description: `Indicate that the object cannot be deleted from a process`,
					}, {
						Name:        []string{`notext`},
						...
						Name:        []string{`origin`},
						Description: `Indicate that the object must have its origin processed`,
					}, {
						Name:        []string{`nocopyreloc`},
						Description: `Disable the creation of copy relocations`,
					}, {
						Name:        []string{`now`},
						Description: `(default) Force all relocations to be processed on load`,
					}, {
						Name:        []string{`lazy`},
						Description: `Don't force all relocations to be processed on load`,
					}, {
						Name:        []string{`relro`},
						Description: `(default) Force all relocations to be read-only after processing`,
					}, {
						Name:        []string{`norelro`},
						Description: `Don't force all relocations to be read-only after processing`,
					}},
				}},
			}, {
				Name:        []string{"-dynamic"},
				...
				Name:        []string{"-Bsymbolic"},
				Description: `Bind global references locally`,
			}, {
				Name:        []string{"--compress-debug-sections"},
				...
				Name:        []string{"-weak-l", "-weak_library"},
				...
				Name:        []string{"--shared-memory"},
				Description: `(WebAssembly) use shared linear memory`,
			}, {
				Name:        []string{"--global-base"},
			...
			Options: []model.Option{{
				...
				Args: []model.Arg{{
					Name:        "value",
					Suggestions: []model.Suggestion{{Name: []string{`return`}}, {Name: []string{`branch`}}, {Name: []string{`full`}}, {Name: []string{`none`}}},
					IsOptional:  true,
				}},
			}, {
				...
				Name: []string{"-fconstant-cfstrings"},
			}, {
				...
				Name: []string{"-felide-constructors"},
			}, {
				Name:        []string{"-feliminate-unused-debug-types"},
				...
				Args: []model.Arg{{
					Name:        "option",
					Suggestions: []model.Suggestion{{Name: []string{`off`}}, {Name: []string{`all`}}, {Name: []string{`bitcode`}}, {Name: []string{`marker`}}},
					IsOptional:  true,
				}},
			}, {
				...
				Name: []string{"-fescaping-block-tail-calls"},
			}, {
				...
				Name:        []string{"-ffinite-loops"},
				Description: `Assume all loops are finite`,
			}, {
				Name: []string{"-ffinite-math-only"},
			}, {
				...
				Name:        []string{"-flegacy-pass-manager"},
				...
				Name:        []string{"-fno-aapcs-bitfield-width"},
				...
				Name: []string{"-fno-apple-pragma-pack"},
			}, {
				Name: []string{"-fno-application-extension"},
			}, {
				...
				Name: []string{"-fno-borland-extensions"},
			}, {
				Name:        []string{"-fno-builtin-value"},
				...
				Name: []string{"-fno-diagnostics-show-hotness"},
			}, {
				...
				Name:        []string{"-fno-eliminate-unused-debug-types"},
				Description: `Emit debug info for defined but unused types`,
			}, {
				Name: []string{"-fno-escaping-block-tail-calls"},
			}, {
				...
				Name:        []string{"-fno-finite-loops"},
				Description: `Do not assume that any loop is finite`,
			}, {
				Name: []string{"-fno-finite-math-only"},
			}, {
				...
				Name:        []string{"-fno-gpu-defer-diag"},
				...
				Name: []string{"-fno-implicit-modules"},
			}, {
				...
				Name:        []string{"-fno-legacy-pass-manager"},
				...
				Name:        []string{"-fno-memory-profile"},
				Description: `Disable heap memory profiling`,
			}, {
				Name:        []string{"-fno-merge-all-constants"},
				Description: `Disallow merging of constants`,
			}, {
				Name: []string{"-fno-modules-validate-system-headers"},
			}, {
				Name: []string{"-fno-objc-arc-exceptions"},
			}, {
				Name: []string{"-fno-objc-convert-messages-to-runtime-calls"},
			}, {
				Name: []string{"-fno-objc-encode-cxx-class-template-spec"},
			}, {
				Name: []string{"-fno-objc-exceptions"},
			}, {
				...
				Name: []string{"-fno-pascal-strings"},
			}, {
				...
				Name:        []string{"-fno-pseudo-probe-for-profiling"},
				...
				Name: []string{"-fno-reciprocal-math"},
			}, {
				...
				Name: []string{"-fno-relaxed-template-template-args"},
			}, {
				...
				Name: []string{"-fno-sanitize-minimal-runtime"},
			}, {
				...
				Name: []string{"-fno-semantic-interposition"},
			}, {
				Name: []string{"-fno-short-enums"},
			}, {
				...
				Name: []string{"-fno-sized-deallocation"},
			}, {
				Name:        []string{"-fno-spell-checking"},
				Description: `Disable spell-checking`,
			}, {
				Name: []string{"-fno-split-dwarf-inlining"},
			}, {
				Name: []string{"-fno-split-lto-unit"},
			}, {
				Name:        []string{"-fno-split-machine-functions"},
				...
				Name: []string{"-fno-strict-vtable-pointers"},
			}, {
				...
				Name: []string{"-fno-visibility-from-dllstorageclass"},
			}, {
				...
				Name: []string{"-fobjc-convert-messages-to-runtime-calls"},
			}, {
				Name:        []string{"-fobjc-disable-direct-methods-for-testing"},
				Description: `Ignore attribute objc_direct so that direct methods can be tested`,
			}, {
				Name:        []string{"-fobjc-encode-cxx-class-template-spec"},
				...
				Name: []string{"-fobjc-infer-related-result-type"},
			}, {
				...
				Name:        []string{"-fprebuilt-implicit-modules"},
				...
				Name:        []string{"-fpseudo-probe-for-profiling"},
				...
				Name: []string{"-fsanitize-minimal-runtime"},
			}, {
				...
				Name: []string{"-fsemantic-interposition"},
			}, {
				...
				Name:        []string{"-fsplit-machine-functions"},
				...
				Name: []string{"-fthreadsafe-statics"},
			}, {
				Name:        []string{"-ftime-report"},
				...
				Name:        []string{"-fvisibility-from-dllstorageclass"},
				...
				Name:        []string{"-fvisibility-nodllstorageclass"},
				...
				Name:        []string{"-fxray-function-groups"},
				...
				Name:        []string{"-fxray-selected-function-group"},
				...
				Name: []string{"-ginline-line-tables"},
			}, {
				...
				Name: []string{"-gno-codeview-ghash"},
			}, {
				Name: []string{"-gno-column-info"},
			}, {
				...
				Name:        []string{"--gpu-instrument-lib"},
				...
				Name:        []string{"-index-ignore-macros"},
				...
				Name: []string{"-mcmodel"},
				Args: []model.Arg{{
					Suggestions: []model.Suggestion{{Name: []string{`small`}}, {Name: []string{`medium`}}, {Name: []string{`medany`}}, {Name: []string{`medlow`}}},
				}},
			}, {
				Name:        []string{"-mcmse"},
				...
				Name:        []string{"-mcode-object-version"},
				...
				Name:        []string{"-menable-unsafe-fp-math"},
				...
				Name:        []string{"-mignore-xcoff-visibility"},
				...
				Name:        []string{"-mmark-bti-property"},
				...
				Name:        []string{"-mno-outline-atomics"},
				...
				Name: []string{"-mno-pie-copy-relocations"},
			}, {
				...
				Name: []string{"-mno-speculative-load-hardening"},
			}, {
				...
				Name: []string{"-mspeculative-load-hardening"},
			}, {
				...
				Name:        []string{"-munsafe-fp-atomics"},
			...
			Options: []model.Option{{
				...
				Args: []model.Arg{{
					Name:        "value",
					Suggestions: []model.Suggestion{{Name: []string{`i386`}}, {Name: []string{`i386:x86-64`}}, {Name: []string{`arm`}}, {Name: []string{`arm64`}}},
				}},
			}, {
				Name:        []string{"-S"},
