...
func init() {
	Specs["less"] = model.Subcommand{
		...
		Options: []model.Option{{
			...
			Name: []string{"-a", "--search-skip-screen"},
...
cases where the terminal bell would have been rung`,
			...
			Name: []string{"-r", "--raw-control-chars"},
